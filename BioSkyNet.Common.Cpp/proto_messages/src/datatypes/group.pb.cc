...
const ::google::protobuf::EnumDescriptor* ItemsSelectionType_descriptor_ = NULL;
...
void protobuf_AssignDesc_datatypes_2fgroup_2eproto() {
  ...
  static const int Group_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Group, selection_type_),
  ...
  ItemsSelectionType_descriptor_ = file->enum_type(0);
}
...
void protobuf_AddDesc_datatypes_2fgroup_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\025datatypes/group.proto\022\tDataTypes\032\023data"
    "types/key.proto\"{\n\005Group\022\032\n\002id\030\001 \001(\0132\016.D"
    "ataTypes.Key\0225\n\016selection_type\030\002 \001(\0162\035.D"
    "ataTypes.ItemsSelectionType\022\037\n\007persons\030\003"
    " \003(\0132\016.DataTypes.Key\"8\n\006Groups\022\037\n\005items\030"
    "\001 \003(\0132\020.DataTypes.Group\022\r\n\005count\030\002 \001(\003*h"
    "\n\022ItemsSelectionType\022\030\n\024Selected_Unspeci"
    "fied\020\000\022\020\n\014Selected_All\020\001\022\021\n\rSelected_Non"
    "e\020\002\022\023\n\017Selected_Custom\020\003BJ\n\007ex.grpcZ9git"
    "hub.com/Enebra/ServiceCoordinator/grpc/d"
    "atatypes/group\242\002\003RTGb\006proto3", 428);
...
const ::google::protobuf::EnumDescriptor* ItemsSelectionType_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ItemsSelectionType_descriptor_;
}
...
const int Group::kSelectionTypeFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_selection_type;
        break;
      }
        ...
        if (tag == 16) {
         parse_selection_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_selection_type(static_cast< ::DataTypes::ItemsSelectionType >(value));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(26)) goto parse_persons;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_loop_persons;
...
void Group::SerializeWithCachedSizes(
  ...
  if (this->selection_type() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      2, this->selection_type(), output);
  }

  // repeated .DataTypes.Key persons = 3;
  for (unsigned int i = 0, n = this->persons_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->persons(i), output);
  }
...
// optional .DataTypes.ItemsSelectionType selection_type = 2;
void Group::clear_selection_type() {
  selection_type_ = 0;
}
 ::DataTypes::ItemsSelectionType Group::selection_type() const {
 ...
 void Group::set_selection_type(::DataTypes::ItemsSelectionType value) {
